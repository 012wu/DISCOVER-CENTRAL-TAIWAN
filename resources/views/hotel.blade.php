@extends('layout')
@section('title', '中彰投生活圈/精選旅宿')
@section('content')
    <section>
        {{-- ========== 列表頁標題橫幅 ========== --}}
        <div class="list-header-banner">
            <div class="container">
                <div class="list-title">精選旅宿</div>
                <div>尋找中彰投最懂生活的停泊之處</div>
            </div>
        </div>
                        ...
                        <div class="list-grid">
                            <div class="list-card" v-for="item in pageData" :key="item.id">
                                <a href="#" @click.prevent="showDetail(item)">
                                    ...
                                    <div class="list-body">
                                        <h4 class="fw-bold">[[ item.hotelName ]]</h4>
                                        {{-- 只抓80個字 --}}
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content detail-modal">
                    <div class="modal-header">
                        <div>
                            <h5 class="modal-title" id="detailName">旅宿名稱</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <div class="fw-bold mb-2">附近旅宿</div>

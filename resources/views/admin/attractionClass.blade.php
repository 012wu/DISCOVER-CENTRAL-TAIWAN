...
@section('title', '中彰投生活圈/後臺管理/景點分類')
@section('content')
{{-- 左上小標 --}}
<div class="admin-breadcrumb">
    <a href="/admin/home">後臺管理</a><span> / </span><a href="#">景點分類</a>
</div>
<div class="admin-page-title">景點分類</div>
<div class="admin-page-desc">管理所有旅遊景點分類</div>
{{-- 下拉式選單＋關鍵字篩選區 --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">修改景點分類</h5>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">新增景點分類</h5>
            ...
            <div class="modal-body">
                ...
                <form onsubmit="submitAdd(event)">
                    ...
                    <div class="mb-3">
                        <label class="form-label">景點分類代碼名稱_網頁</label>
                        <input type="text" name="attractionClassName2" class="form-control">
                    </div>
...
@push('scripts')
<script>
    // 新增:呼叫 POST /api/attractionClass
    function submitAdd(event) {
        event.preventDefault();
        const form = event.target;
        const data = Object.fromEntries(new FormData(form));

        fetch('/api/attractionClass', {
                method: 'POST',
                headers: {
    ...
    // 修改:呼叫 PUT /api/attractionClass/{id}
    function submitEdit(event, id) {
        event.preventDefault();
        const form = event.target;
        const data = Object.fromEntries(new FormData(form));

        fetch(`/api/attractionClass/${id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    // 刪除:呼叫 DELETE /api/attractionClass/{id}

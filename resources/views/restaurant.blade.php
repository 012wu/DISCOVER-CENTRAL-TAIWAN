@extends('layout')
@section('title', '中彰投生活圈/餐飲饗宴')
@section('content')
    <section>
        {{-- ========== 列表頁標題橫幅 ========== --}}
        <div class="list-header-banner">
            <div class="container">
                <div class="list-title">餐飲饗宴</div>
                <div>尋找中彰投最迷人的舌尖風味</div>
            </div>
        </div>
        <div class="container my-4">
            ...
            <div class="filter-bar mb-4">
                ...
                <select class="form-select" id="categorySelect" v-model="selectedCategory" style="flex:1;">
                    ...
                    <option value="在地與台式風味">在地與台式風味</option>
                    <option value="日韓與亞洲料理">日韓與亞洲料理</option>
                    <option value="其他異國與聚餐">其他異國與聚餐</option>
                    <option value="甜點輕食特殊餐">甜點輕食特殊餐</option>
                </select>
                        ...
                        <div class="list-grid">
                            <div class="list-card" v-for="item in pageData" :key="item.id">
                                <a href="#" @click.prevent="showDetail(item)">
                                    ...
                                    <div class="list-body">
                                        <h4 class="fw-bold">[[ item.restaurantName ]]</h4>
                                        {{-- 只抓80個字 --}}
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content detail-modal">
                    <div class="modal-header">
                        <div>
                            <h5 class="modal-title" id="detailName">餐飲名稱</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <div class="fw-bold mb-2">附近餐飲</div>
